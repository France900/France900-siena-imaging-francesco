...
// database immagini
var arrayNest = ["img/img_lights_wide.jpg", "img/img_nature_wide.jpg", "img/img_snow_wide.jpg", "img/img_lights_wide.jpg", "img/img_nature_wide.jpg", "img/img_snow_wide.jpg", "img/img_lights_wide.jpg", "img/img_nature_wide.jpg", "img/img_snow_wide.jpg", "img/img_lights_wide.jpg", "img/img_nature_wide.jpg", "img/img_snow_wide.jpg", "img/img_lights_wide.jpg", "img/img_nature_wide.jpg", "img/img_snow_wide.jpg", "img/img_mountains_wide.jpg"];
//#endregion
...
function inserisciCarosello() {
  var section = '<section>' + '<div class="slideshow-container mySlides fade">' + '</div>' + '<div class="slideControls">' + '<div class="prev" onclick="sliderMover(\'retreat\')">&#10094;</div>' + '<div class="dots" style="text-align:center">' + '</div>' + '<div class="next" onclick="sliderMover(\'advance\')">&#10095;</i></div>' + '</div>' + '</section>';
  // QUI IL TAG PRINCIPALE IN CUI SI APPENDE - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
  $('main').append(section);
  aggiornaImmagine();
  // genero i dot in numero uguale a arrayNest.lenght
  for (var index = 0; index < arrayNest.length; index++) {
...
function aggiornaImmagine() {
  $('.mySlides').empty();
  var element = '<div class="numbertext">' + currentSlide + '/' + arrayNest.length + '</div>' + '<img src="' + arrayNest[currentSlide - 1] + '">';
