  ...
  $('.pluss').click(function () {
    ...
    if (refertChoice == "referto_1") {
      ...
      for (var i = 0; i < referto_1.length; i++) {
        slider += '<div class="mySlides fade">' + '<div class="numbertext">' + (i + 1) + '/' + referto_1.length + '</div>' + '<img src="' + referto_1[i] + '">' + '</div>';
      }
      $('main').append(slider);
    } else if (refertChoice == "referto_2") {
      var slider = '';
      for (var _i = 0; _i < referto_2.length; _i++) {
        slider += '<div class="mySlides fade">' + '<div class="numbertext">' + (_i + 1) + '/' + referto_2.length + '</div>' + '<img src="' + referto_2[_i] + '">' + '</div>';
      }
      $('main').append(slider);
    } else if (refertChoice == "referto_3") {
      var slider = '';
      for (var _i2 = 0; _i2 < referto_3.length; _i2++) {
        slider += '<div class="mySlides fade">' + '<div class="numbertext">' + (_i2 + 1) + '/' + referto_3.length + '</div>' + '<img src="' + referto_3[_i2] + '">' + '</div>';
      }
      $('main').append(slider);
    } else if (refertChoice == "referto_4") {
      var slider = '';
      for (var _i3 = 0; _i3 < referto_4.length; _i3++) {
        slider += '<div class="mySlides fade">' + '<div class="numbertext">' + (_i3 + 1) + '/' + referto_4.length + '</div>' + '<img src="' + referto_4[_i3] + '">' + '</div>';
      }
      $('main').append(slider);
    } else {
